...
2. INSERT, 기초 데이터 추가 
- Duplicate entry 'arj2199216@gmail.com' for key 'email': 이메일 중복 등록 불가능
...
3) 관리자 등록
   ...
   VALUES('arj2199216@gmail.com', '135apfhd', 'AXD0123456789012', 'M', 'Y', now());
...
4) 이메일 인증
  UPDATE admin4
  SET confirm = 'Y'
  WHERE email='arj2199216@gmail.com' AND auth='AXD0123456789012';
