...
<DIV class='content'>  
  ...
  <DIV class='aside_menu'>
    ...
    <ASIDE style='float: left;'><A href='../category4/list.jsp'>게시판</A>＞<A href='./list_category_table2.jsp?categoryno=<%=categoryno %>'><%=category_title %></A>＞목록</ASIDE> 
    <ASIDE style='float: right;'>
...
%> 
  <TR>
    ...
    <TD class='td_basic'>
      ...
      %>
      <A href='./update_form.jsp?pdsno=<%=pdsno %>&categoryno=<%=categoryno%>&col=<%=col%>&word=<%=word%>&nowPage=<%=nowPage%>'><IMG src='./images/update.png' title='수정'></A>
      <A href='./delete_form.jsp?pdsno=<%=pdsno %>&categoryno=<%=categoryno%>&col=<%=col%>&word=<%=word%>&nowPage=<%=nowPage%>'><IMG src='./images/delete.png' title='삭제'></A>
    </TD>
