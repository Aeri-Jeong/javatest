  ...
  <fieldset class='fieldset_no_line'>
    <ul>
      <li class='li_none'>
        ...
        <input class='input_basic' type='text' name='title' id='title' size='50' >
      </li>
      <li class='li_none'>
       ...
       <li class='li_none'>
        ...
        <DIV style='display: table; height: 100px;'>
          <DIV style='display: table-cell;'>
            ...
            <input class='input_basic' style='vertical-align: middle;' type="file" name='mp4' id='mp4' size='50'> (음악 파일(MP4), 1000 MB 이하만 전송 가능)
          </DIV>
        </DIV>
      </li>
