<%@ page contentType="text/html; charset=UTF-8" %>
 ...
 <% int maxseqno=categoryProc.getMaxSeqno(); %>
  ...
  <form name='frm' action='./create_proc.jsp' method='POST'>
    <fieldset class='fieldset_basic'>
     ...
     <DIV style='text-align: center;'>
      <ul>
        <li class='li_none'>
          <input type='text' name='title' id='title'  style='width: 25%;' placeholder="게시판 제목">*
...
%>
    <TR>
      ...
      <TD class='td_basic'>
       <A href='../pds4/create_form.jsp?categoryno=<%=categoryno %>'><IMG src='./images/update2.png' style='width: 12px;'' title="카테고리에 해당하는 글 등록"></A>
       <A href='./high.jsp?categoryno=<%=categoryno %>'><IMG src='./images/up.jpg' style='width: 12px;'></A>
       <A href='./low.jsp?categoryno=<%=categoryno %>'><IMG src='./images/down.jpg' style='width: 12px;'></A>
